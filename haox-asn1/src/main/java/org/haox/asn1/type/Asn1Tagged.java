...
public class Asn1Tagged<T extends Asn1Type> extends AbstractAsn1Type<T> {

    public Asn1Tagged() {
        this(-1, null);
    }

    public Asn1Tagged(int tagNo, T value) {
        super(TagClass.CONTEXT_SPECIFIC.getValue(), tagNo, value);
    }
