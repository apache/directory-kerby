...
public class Des {
    ...
    public static void cbc_encrypt (
                                    ...
                                    byte[] key,
                                    byte[] ivec,
                                    boolean encrypt) throws KrbException {
     ...
     */
    public static long char_to_key(char[] passwdChars) throws KrbException {
        long key = 0;
        ...
        try {
            ...
            KrbException ce =
                new KrbException("Unable to convert passwd, " + e);
            ce.initCause(e);
            throw ce;
        }
     ...
     * @created by Yanni Zhang, Dec 6, 99.
     */
    public static byte[] des_cksum(byte[] ivec, byte[] msg, byte[] key) throws KrbException {
        Cipher cipher = null;
