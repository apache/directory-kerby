...
public class AuthenticationService
{
    ...
    private static void selectEncryptionType( AuthenticationContext authContext ) throws KerberosException,
        ...
        Set<EncryptionType> requestedTypes = kdcContext.getRequest().getReqBody().getEtype();
        ...
        EncryptionType bestType = EncryptionUtil.getBestEncryptionType(requestedTypes, config.getEncryptionTypes());
