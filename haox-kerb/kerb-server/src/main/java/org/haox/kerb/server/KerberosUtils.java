...
public class KerberosUtils
{
    ...
    /**
     * Get a PrincipalStoreEntry given a principal.  The KrbErrorCode is used to indicate
     * whether any resulting error pertains to a server or client.
     */
    public static PrincipalStoreEntry getEntry(KerberosPrincipal principal, 
            PrincipalStore store, KrbErrorCode KrbErrorCode) throws KrbException
    {
