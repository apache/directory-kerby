...
public class KerberosConfig
{
    ...
    {
        setSearchBaseDn("ou=users,dc=example,dc=com");
    ...
    public void setEncryptionTypes( EncryptionType[] encryptionTypes )
    {
        ...
        this.encryptionTypes = EncryptionUtil.orderEtypesByStrength(this.encryptionTypes);
    }
    ...
    {
        this.encryptionTypes = EncryptionUtil.orderEtypesByStrength( encryptionTypes );
    }
    ...
    private void prepareEncryptionTypes()
    {
        ...
        for ( String enc : encryptionTypeStrings )
        {
            ...
            {
                if ( type.name().equalsIgnoreCase( enc ) )
                {
        ...
        encryptionTypes = EncryptionUtil.orderEtypesByStrength( encryptionTypes );
    }
}
