 ...
 * @author Rosanna Lee
 */
public class GssKrb5ServerExt extends GssKrb5BaseExt implements SaslServer {
    private static final String MY_CLASS_NAME = GssKrb5ServerExt.class.getName();
     ...
     * with the client.
     */
    GssKrb5ServerExt(String protocol, String serverName,
